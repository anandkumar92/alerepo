             															...
             															_create : function()
             															           {
             															            ...
             															            if ($('#lightbox_toolkit_lb').length > 0)
             															             {
             															              ourPoints = ale.toolkit.getData().content[0].timeline_options.points;
             															              ourTimes = ale.toolkit.getData().content[0].timeline_options.times;
             															             }
             															            else
             															             {
             															                                                                             ...
             															                                                                             'callback' : function()
             															                                                                                           {
             															                                                                                              ...
             															                                                                                              if ($('#lightbox_toolkit_lb').length > 0)
             															                                                                                               {
             															                                                                                                setTimeout(function()
             															                                                                                                            {
             															                                                                                                             $('#lightbox_things_lb').css('left', ($('.timeline_point.active').offset().left) - 20)
             															                                                                                                                                     .css('top', ($('.timeline_point.active').offset().top - style.height) - 30);
             															                                                                                                            }, 0);
             															                                                                                               }
             															                                                                                              else
             															                                                                                               {
             															                                                                                            ...
             															                                                                                            if ($('#lightbox_toolkit_lb').length > 0 && style === undefined)
                                                                                                                         {
                                                                                                                          $('#lightbox_things_lb').css('left', ($('.timeline_point.active').offset().left) - 20)
                                                                                                                                                  .css('top', ($('.timeline_point.active').offset().top - $('#lightbox_things_lb').height()) - 30);
                                                                                                                         }
             															                                                                                            ...
             															                                                                                            ale.template.fixImgPaths('#lightbox_things_lb');
